...
export function OwnerDashboard() {
    ...
    if (transcriptIndex >= demoTranscript.length && isCallActive) {
      const endTimer = setTimeout(() => {
        ...
        const newBooking: BookingRequest = {
          ...
          clientName: liveBooking.name || "Sophie Martin",
          service: liveBooking.service || "Haircut",
          requestedDate: liveBooking.date || "June 5, 2026",
          requestedTime: liveBooking.time || "3:00 PM",
          originalLanguage: liveBooking.language || "French",
          phone: liveBooking.phone || "+1 (555) 555-0192",
  ...
  }, [transcriptIndex, isCallActive, bookings.length, liveBooking]);
        ...
        <div className="max-w-[1600px] mx-auto px-8 py-5">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h1 className="text-xl text-neutral-900 tracking-tight">{t.dashboard}</h1>
            ...
            <div className="flex items-center gap-6">
              ...
              {isCallActive && (
                <div className="flex items-center gap-2 px-4 py-2 bg-emerald-50 border border-emerald-200 rounded-lg">
                  ...
                  <span className="text-sm text-emerald-900">{t.callInProgress}</span>
                </div>
              )}
            </div>
          </div>
                ...
                <div className="bg-neutral-900 px-8 py-6">
                  <div className="flex items-center justify-between mb-4">
                    <div className="flex items-center gap-4">
                      ...
                      <div>
                        <div className="text-white text-lg">{t.incomingCall}</div>
                      ...
                      {[...Array(40)].map((_, i) => (
                        <div
                          ...
                          style={{
                            height: `${Math.max(
                              4,
                              Math.sin(i * 0.5 + audioLevel * 0.05) * 30 + 20
                            )}px`,
                            opacity:
